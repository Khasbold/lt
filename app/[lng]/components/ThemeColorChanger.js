        ...
        <Menu as="div" className="relative inline-block text-left z-50">
            <div>
                {currentTheme === 'dark' ? (
                    ...
                    <Menu.Button onClick={() => setTheme('dark')} className="inline-flex w-full justify-center rounded-md hover:bg-indigo-800 bg-opacity-20 px-4 py-2 text-sm font-medium text-white hover:bg-opacity-30 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
